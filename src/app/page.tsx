  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <nav className="max-w-6xl mx-auto px-4 py-6 flex justify-between items-center">
        <div className="text-xl font-bold text-indigo-600">EventosPro</div>
        <Link
          href="/admin"
      ...
      <main className="max-w-4xl mx-auto px-4 pt-20 pb-32 text-center">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
          Planifica tu evento
          <br />
          <span className="text-indigo-600">perfecto</span>
        </h1>
        ...
        <Link
          href="/cotizar"
          className="inline-flex items-center px-8 py-4 bg-indigo-600 text-white text-lg font-semibold rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
        >
          Cotizar ahora →
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          <div className="text-left p-6 rounded-xl bg-white shadow-sm border border-gray-100">
            <div className="text-3xl mb-4">💒</div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Bodas</h3>
